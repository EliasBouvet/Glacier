...
///FIREBASE AVSLUTT
  ...
  function getGeneratorState() {
   ...
   .then((data) =>{
     const formatMoneyEarned = new Intl.NumberFormat('no-NO', { style: 'currency', currency: 'NOK' }).format(data.money/1000000)
     setMoneyEarned(formatMoneyEarned)
     const formatEnvmCost = new Intl.NumberFormat('no-NO', { style: 'currency', currency: 'NOK' }).format(data.environmentCost/1000000)
        ...
        <GridItem xs={12} sm={12} md={6} lg={6}>
          <Card>
            ...
            <CardIcon color="info">
              ...
              <p className={classes.cardCategory}>Værprognose for Bodø</p>
              <h3 className={classes.cardTitle}>
                15 mm
              </h3>
            </CardHeader>
        ...
        <GridItem xs={12} sm={6} md={6} lg={3}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <h3 className={classes.cardTitle}>kr {powerPrice}/MWh</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <DateRange />
        ...
        <GridItem xs={12} sm={6} md={6} lg={3}>
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <h3 className={classes.cardTitle}>{moneyEarned}M</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <Update />
        ...
        <GridItem xs={12} sm={6} md={6} lg={3}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <h3 className={classes.cardTitle}>{environmentCost}M</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <Update />
